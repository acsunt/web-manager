...
function togglePageFollowScale() { const follow = document.getElementById('pageFollowScaleCheck'); themeConfig.pageFollowScale = follow ? !!follow.checked : true; applyThemeSettings(); saveThemeConfig(); }
...
function resetSiteData(keepTheme = false) {
    ...
    if (!keepTheme) {
        ...
        const scaleFollow = document.getElementById('pageFollowScaleCheck');
        if (scaleFollow) scaleFollow.checked = true;
...
const inlineHandlers = {
    ...
    openLinkCheckModal,
    startPendingCheck,
    openLocalPageToolModal,
    convertLocalPageText,
    toggleToolsDataManage,
    openPasswordManager,
    savePasswordDraft,
    cancelPasswordDraft,
